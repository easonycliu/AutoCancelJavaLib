...
public class TaskTracker {
    ...
    public void onTaskCreate(Object task, Boolean isCancellable) throws AssertionError {        
        ...
        if (parentCancellableID != null) {
            CancellableID cid = this.mainManager.createCancellableIDOnCurrentJavaThreadID(true, task.toString(), wrappedTask.getAction(), parentCancellableID, wrappedTask.getStartTime());
